...
ActiveRecord::Schema.define(version: 20160229205842) do
  ...
  create_table "marker_photos", force: true do |t|
    t.string   "photo"
    t.string   "title"
    t.integer  "marker_id"
    t.datetime "created_at"
  ...
  add_index "marker_photos", ["marker_id"], name: "index_marker_photos_on_marker_id"
  ...
  create_table "news", force: true do |t|
    ...
    t.boolean  "show_in_main_list", default: true
  end
  ...
  add_index "news_photos", ["news_id"], name: "index_news_photos_on_news_id"
